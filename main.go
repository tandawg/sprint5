...
func (w Walking) Calories() float64 {
	...
	heightMeters := w.Height / CmInM
	return (CaloriesWeightMultiplier*w.Weight + math.Pow(speed, 2)/heightMeters*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * MinInHours
}
